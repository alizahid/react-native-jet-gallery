...
namespace margelo::nitro::nitrogallery {
   ...
   */
  struct GalleryActionPayload final {
  public:
  ...
  public:
    GalleryActionPayload() = default;
    explicit GalleryActionPayload(std::string actionId, double index, std::string url): actionId(actionId), index(index), url(url) {}
