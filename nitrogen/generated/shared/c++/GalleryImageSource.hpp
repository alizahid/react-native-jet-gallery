...
namespace margelo::nitro::jetgallery {
  ...
  /**
   * A struct which can be represented as a JavaScript object (GalleryImageSource).
   */
...
namespace margelo::nitro {
  ...
  // C++ GalleryImageSource <> JS GalleryImageSource (object)
  template <>
  struct JSIConverter<margelo::nitro::jetgallery::GalleryImageSource> final {
    static inline margelo::nitro::jetgallery::GalleryImageSource fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
