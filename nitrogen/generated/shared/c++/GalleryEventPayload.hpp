...
namespace margelo::nitro::jetgallery {
   ...
   */
  struct GalleryEventPayload final {
  public:
    double index     SWIFT_PRIVATE;
    std::string url     SWIFT_PRIVATE;

  public:
    GalleryEventPayload() = default;
    explicit GalleryEventPayload(double index, std::string url): index(index), url(url) {}
