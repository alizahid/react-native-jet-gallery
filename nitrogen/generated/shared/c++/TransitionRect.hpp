...
namespace margelo::nitro::jetgallery {
  ...
  public:
    TransitionRect() = default;
    explicit TransitionRect(double x, double y, double width, double height, std::optional<double> borderRadius): x(x), y(y), width(width), height(height), borderRadius(borderRadius) {}
...
namespace margelo::nitro {
  ...
  struct JSIConverter<margelo::nitro::jetgallery::TransitionRect> final {
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::jetgallery::TransitionRect& arg) {
      ...
      obj.setProperty(runtime, PropNameIDCache::get(runtime, "borderRadius"), JSIConverter<std::optional<double>>::toJSI(runtime, arg.borderRadius));
      return obj;
    }
    static inline bool canConvert(jsi::Runtime& runtime, const jsi::Value& value) {
      ...
      if (!JSIConverter<std::optional<double>>::canConvert(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "borderRadius")))) return false;
      return true;
    }
  };
