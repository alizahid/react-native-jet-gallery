...
/**
 * Represents an instance of `GalleryImageSource`, backed by a C++ struct.
 */
public typealias GalleryImageSource = margelo.nitro.jetgallery.GalleryImageSource

public extension GalleryImageSource {
